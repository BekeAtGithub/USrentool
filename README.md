...
- **20-Year Rent Growth** - Long-term rental income projections
- **5-Year Appreciation** - Property value growth analysis
- **Total Return Analysis** - Combined ROI from all sources (Cash Flow, Debt Paydown, Tax Savings, Appreciation)
...
- This lets you pay tax only on NET income (after expenses) at normal rates (15-25%)
